...
<section class="filmList">
	...
	if (isset($filmList) && sizeof($filmList) > 0) {
		...
		<article>
			<div class="content">
				<a href="details.php?id=<?php echo $currentFilm->getId(); ?>"><img src="<?php echo $currentFilm->getAffiche(); ?>" border="0" /></a>
				<div class="titre">
					#<?php echo $currentFilm->getId(); ?>&nbsp;
					<a href="details.php?id=<?php echo $currentFilm->getId(); ?>"><?php echo $currentFilm->getTitre(); ?></a>
				</div>
				<div class="synopsis">
			...
			<div class="actions">
				<a class="btn" href="details.php?id=<?php echo $currentFilm->getId(); ?>">Détails</a><br />
